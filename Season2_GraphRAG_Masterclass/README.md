# 🕸️ Season 2: Enterprise GraphRAG Masterclass (Cognitive Search)
...
### 🧱 Phase 1: Structural Data Parsing (비정형 데이터 정제)
...
텍스트 덩어리를 그래프 모델로 변환하기 위해 엔티티와 관계를 정교하게 발라냅니다.
...
그래프의 구조적 연결성과 벡터의 의미적 유사성을 통합합니다.
...
지식망 탐색 과정을 일반 사용자도 보기 쉽도록 웹 대시보드와 그래프 토폴로지로 시각화합니다.
...
실시간으로 추가되는 원본 파일을 추적하고 처리하는 자동화 데몬입니다.
